...
public class Quiz_Lv6 {
    ...
    void setAllQuizSoundChordList(){
        ...
        allQuizSoundChordList = new Chord [36];
        ...
        allQuizSoundChordList[4].setChord("C", "G#");
        allQuizSoundChordList[5].setChord("C", "A");
        ...
        allQuizSoundChordList[6].setChord("C#", "E");
        allQuizSoundChordList[7].setChord("C#", "F");
        allQuizSoundChordList[8].setChord("C#", "F#");
        //allQuizSoundChordList[16].setChord("C#", "G");
        allQuizSoundChordList[9].setChord("C#", "G#");
        allQuizSoundChordList[10].setChord("C#", "A");
        allQuizSoundChordList[11].setChord("C#", "A#");
        //allQuizSoundChordList[20].setChord("C#", "B");

        //allQuizSoundChordList[21].setChord("D", "D#");
        //allQuizSoundChordList[22].setChord("D", "E");
        allQuizSoundChordList[12].setChord("D", "F");
        allQuizSoundChordList[13].setChord("D", "F#");
        allQuizSoundChordList[14].setChord("D", "G");
        //allQuizSoundChordList[26].setChord("D", "G#");
        allQuizSoundChordList[15].setChord("D", "A");
        allQuizSoundChordList[16].setChord("D", "A#");
        allQuizSoundChordList[17].setChord("D", "B");

        //allQuizSoundChordList[30].setChord("D#", "E");
        //allQuizSoundChordList[31].setChord("D#", "F");
        allQuizSoundChordList[18].setChord("D#", "F#");
        allQuizSoundChordList[19].setChord("D#", "G");
        allQuizSoundChordList[20].setChord("D#", "G#");
        //allQuizSoundChordList[35].setChord("D#", "A");
        allQuizSoundChordList[21].setChord("D#", "A#");
        allQuizSoundChordList[22].setChord("D#", "B");

        //allQuizSoundChordList[38].setChord("E", "F");
        //allQuizSoundChordList[39].setChord("E", "F#");
        allQuizSoundChordList[23].setChord("E", "G");
        allQuizSoundChordList[24].setChord("E", "G#");
        allQuizSoundChordList[25].setChord("E", "A");
        //allQuizSoundChordList[43].setChord("E", "A#");
        allQuizSoundChordList[26].setChord("E", "B");

        //allQuizSoundChordList[45].setChord("F", "F#");
        //allQuizSoundChordList[46].setChord("F", "G");
        allQuizSoundChordList[27].setChord("F", "G#");
        allQuizSoundChordList[28].setChord("F", "A");
        allQuizSoundChordList[29].setChord("F", "A#");
        //allQuizSoundChordList[50].setChord("F", "B");

        //allQuizSoundChordList[51].setChord("F#", "G");
        //allQuizSoundChordList[52].setChord("F#", "G#");
        allQuizSoundChordList[30].setChord("F#", "A");
        allQuizSoundChordList[31].setChord("F#", "A#");
        allQuizSoundChordList[32].setChord("F#", "B");

        //allQuizSoundChordList[56].setChord("G", "G#");
        //allQuizSoundChordList[57].setChord("G", "A");
        allQuizSoundChordList[33].setChord("G", "A#");
        allQuizSoundChordList[34].setChord("G", "B");

        //allQuizSoundChordList[60].setChord("G#", "A");
        //allQuizSoundChordList[61].setChord("G#", "A#");
        allQuizSoundChordList[35].setChord("G#", "B");
