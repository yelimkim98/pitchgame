...
public class Quiz_Lv2 {
    ...
    void setAllQuizSoundChordList(){
        ...
        allQuizSoundChordList = new Chord [8];
        for(int i=0;i<allQuizSoundChordList.length;i++) allQuizSoundChordList[i] = new Chord();
        //allQuizSoundChordList[0].setChord("C", "D");
        allQuizSoundChordList[0].setChord("C", "E");
        //allQuizSoundChordList[1].setChord("C", "F");
        allQuizSoundChordList[1].setChord("C", "G");
        //allQuizSoundChordList[3].setChord("C", "A");
        //allQuizSoundChordList[5].setChord("C", "B");

        //allQuizSoundChordList[6].setChord("D", "E");
        allQuizSoundChordList[2].setChord("D", "F");
        //allQuizSoundChordList[5].setChord("D", "G");
        allQuizSoundChordList[3].setChord("D", "A");
        //allQuizSoundChordList[7].setChord("D", "B");

        //allQuizSoundChordList[11].setChord("E", "F");
        allQuizSoundChordList[4].setChord("E", "G");
        //allQuizSoundChordList[9].setChord("E", "A");
        allQuizSoundChordList[5].setChord("E", "B");

        //allQuizSoundChordList[15].setChord("F", "G");
        allQuizSoundChordList[6].setChord("F", "A");
        //allQuizSoundChordList[17].setChord("F", "B");

        //allQuizSoundChordList[18].setChord("G", "A");
        allQuizSoundChordList[7].setChord("G", "B");
